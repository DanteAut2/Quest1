...
public class TestBase {
    ...
    protected void InputSecondary(InputSecondarys inputSecondarys) { //Ввод полей Secondary
    ...
    protected void inputBdayAday(InputDates inputDates) { //Ввод Дат
    ...
    protected void inputHomepage(String homepage) {
        wd.findElement(By.name("homepage")).click();
        wd.findElement(By.name("homepage")).clear();
        wd.findElement(By.name("homepage")).sendKeys(homepage);
    }

    protected void inputEmails(InputEmails inputEmails) {
    ...
    protected void homeMobileWorkFaxNumber(InputNumbers inputNumbers) { //Ввод ввод номеров телефонов
    ...
    protected void inputAddress(String address) {
        wd.findElement(By.name("address")).click();
        wd.findElement(By.name("address")).clear();
        wd.findElement(By.name("address")).sendKeys(address);
    }

    protected void inputCompany(String company) {
    ...
    protected void inputNickname(String nickname) {
        wd.findElement(By.name("nickname")).click();
        wd.findElement(By.name("nickname")).clear();
        wd.findElement(By.name("nickname")).sendKeys(nickname);
    }

    protected void inputFirstMiddleLastName(InputNames inputNames) { //Ввод ФИО
